...
| Game-Master | Phil [comicbookvillain] |
| Rules | Pathfinder 1 |
...
| Adventure |Echos of Eternity|
|---|---|
| Language | English |
| Game-Master | Dylan [blue0ri0n] |
| Rules | DnD 5e |
| Suitable for | Some experience needed! |
| Description | Death is but the next great adventure, or so the saying goes. You all have died, your souls appearing moments from each other in the sweltering cold of a world wrapped in mist, aimless souls drifting through the fog that encompasses all. A sourceless whisper in your ears, with the promise of a second attempt at mortal life, should you be able to weave your way through the In-between and activate the Soul Spring Altar. But already now, you can feel your oldest memories slowly fade, drifting away like a leaf on water. And you wonder, is this a chance at revival, or rebirth? |
| Players | 4-6 |
| Duration | 4-5 h |
| Characters | Make yourself with base Materials, ask DM for extended official Ressources. In emergencies DM can provide some premade ones |
...
| Rules | DnD 5e |
| Suitable for | players who have played before, but don't need to be experts |
...
| Adventure | Scotland Extreme |
|---|---|
| Language | Deutsch |
| Game-Master | Erik [rickeyrock] |
| Rules | interaktive RPG System with d10s, excel sheets and easy rules |
| Suitable for | Neulinge bis Veteranen sind willkommen |
| Description | "Tauche ein in die faszinierende Welt von SE (Scotland Extreme), einem interaktiven Rollenspielabenteuer voller Geheimnisse, Magie und unerwarteter Wendungen. Du betrittst 1840 eine Stadt namens Falkirk, einem scheinbar normalen Dorf auf einer Insel. Doch findest du dich in einem Kampf gegen die Dunkelheit wieder. Der Schein kann trügen und jeder Verbündete könnte sich als Feind entpuppen. - Gefangen in einem Wettlauf gegen die Zeit musst du Rätsel lösen, Geheimnisse aufdecken und dich gegen gefährliche Feinde behaupten, um das Schicksal von Falkirk und seiner Bewohner zu entscheiden. - Bist du bereit, die Geheimnisse zu lüften?" |
| Players | 2-10 (only 6 at a time) |
| Duration | 4h |
| Characters | werden gemeinsam erstellt - auf jeden wird Rücksicht genommen |

### 16:00

| Adventure | Eye, Eye Captiaon: A Spelljammer Adventure|
|---|---|
| Language | English |
| Game-Master | Sarah [starshine001] |
| Rules | DnD 5e |
| Suitable for | Everyone - Noobs welcome! |
| Description | Your jolly, patchwork group has come together for one purpose: Seek thrill, glory and fame as a space-faring adventuring crew. It was that drive that sent you sailing through the Astral Sea on the fastest course to the large spaceport of Bral, where you hoped to resupply and find some adventuring gig or other. Your plans were, unfortunately, rudely upended when you were attacked by plasmoid space pirates who damaged your ship. Now, you are stranded in the obscure star system of Uklun. - If you want to stand any chance of getting back on track and sailing on to your adventuring dreams, you must first get rid of these pesky pirates...and their mysterious boss.|
| Players | 3-5 |
| Duration | 3-4 h|
...
| Adventure | The Crystal Run - Childs first Adventure Summer Camp! |
|---|---|
| Language | English |
| Game-Master | Kai [kai_kay] and Ellie [ellie_birb] |
| Rules | DnD 5e |
| Suitable for | Everyone - Noobs welcome! |
| Description | Your first actual Adventure! After having practised for weeks in a summer camp tomorrow is your time to shine! In the "Crystal Run" two groups will compete in a race through the Grove Woods to the top of the Dark Mountain to be the first to touch the turquoise crystal and win the grand trophy and their first adventurers contract. Are you up for the challenge? |
| Players | 6-10 (in two groups) |
| Duration | 4-5 h|
| Characters | You play as a 8-17 year old Child/Teenager. Characters are premade by the DMs but you can bring your own of Level 3 if you contact us beforehand |
...
| Language | English (can play in German if all Players want to)|
| Game-Master | Wolfgang [wolfgang2703] |
| Rules | simplified DnD |
| Suitable for | All experience Levels welcome! |
...
| Players | 2-5 |
| Duration | 3 h |
| Characters |  The rules should be simple enough to create caracters at the table. You can think of a character concept beforehand, we will probably be able to make it work. The setting is classic fantasy (think d&d). |
...
| Rules | Dungeonslayers |
| Suitable for | Keine Vorerfahrung notwendig |
| Description | Ihr seid eine Gruppe aus Ganoven und Verbrecher jeder von euch hat einen Brief von  Herrn Salin bekommen, der euch einlädt, durch seinen Verwalter Mr. Bones geprüft zu werden. Mr. Bones sendet euch auf eine Mission voller Mord und Totschlag. Solltet ihr überleben werdet ihr durch Salin selbst reichlich entschädigt. |
| Players | 3-4 |
| Duration | 3-5 h |
| Characters | sind vorgefertigt, aber können auch selbst erstellt werden, kontaktiere dafür deinen Game-Master |
...
| Language | Deutsch |
| Game-Master | Kneidi [templar42] |
| Rules | Schatten des Dämonenfürsten |
| Suitable for | Von Neuling bis Veteran sind alle willkommen! |
| Description | Der Schatten des Dämonenfürsten ist ein Rollenspiel, das in den letzten Tagen einer Fantasy-Welt spielt.  Doch so aussichtslos die Lage zu sein schient, gibt es immer wieder Streiter die das Unaufhaltsame verzögern oder gar vernichten? Übernimm die Rolle einer/s Reisenden und übernachte im gemütlichen Gasthaus nahe der tiefen Wälder. Doch zur Beginn der Nacht beginnt im Geißhorn (oder war es Gääßhorn?) der wahre Schrecken. |
| Players | 3-5 |
| Duration | 3 h |
...
| Rules | Kingdom (a role-play focussed, beginner-friendly PnP without dice) |
| Suitable for | Everyone - Noobs welcome |
| Description | In Kingdom, we play as influential members of a kingdom, facing an all-ending crisis. We narrate the story together and decide if our land comes together and survives the crisis or succumbs to egoistical goals and goes up in flames. Our kingdom rests on top of an enormous tortoise, peacefully floating through the sea. No-one can remember a time before the tortoise. No-one can imagine a time after the tortoise. Well, you better wake up the historians, because a new era is upon us! |
| Players | 3-6 |
| Duration | 3-4 h |
| Characters | and world are made at the table |
